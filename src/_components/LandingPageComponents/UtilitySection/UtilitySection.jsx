...
// import setting from '../../../_assets/images/Group 266.png';
// import question from '../../../_assets/images/Group 269.png';
// import light from '../../../_assets/images/Group 268.png';

function UtilitySection() {
    return(
        <div className="utility w-full h-full min-h-screen relative flex items-center">
            ...
            <div className="description w-full lg:w-3/6 z-10">
                ...
                <div className="utility-desc text-xs">
                    ...
                    <div className="utility-desc-item">
                        ...
                        <div className="ml-3 sm:ml-5 max-w-lg leading-5">
